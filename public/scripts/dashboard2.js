/**
 * ====================================================================
 * DASHBOARD APP - REWRITE COMPLETA E MINIMALISTA (ES6 Classes)
 * Pronto per il Copy-Paste: Contiene TUTTA la logica originale.
 * ====================================================================
 */
...
const CONFIG = {
    ...
    // Lista completa di tutti gli ID DOM usati
    DOM_REFS: {
    ...
    async handleAIPreview(fieldName) {
        ...
        try {
            const resp = await this.#api.post('aiGenerateDebriefSection', {
                coachId: this.#coach.id, studentName: student, fieldName: fieldName, context: content 
            });
